  ...
  <div class="app-shell">
    <aside class="app-sidebar">
      ...
      <nav class="sidebar-nav">
        <div class="app-nav-section">My Location</div>
        <RouterLink v-for="item in locationNav" :key="item.to" :to="item.to"
          :class="['app-nav-item', isActive(item.to) && 'active']">
          <i :class="`ph ${item.icon}`" class="nav-icon"></i>{{ item.label }}
        </RouterLink>

        <div class="app-nav-section">Clients & Revenue</div>
        <RouterLink v-for="item in clientRevenueNav" :key="item.to" :to="item.to"
          :class="['app-nav-item', isActive(item.to) && 'active']">
          <i :class="`ph ${item.icon}`" class="nav-icon"></i>{{ item.label }}
        </RouterLink>

        <div class="app-nav-section">Operations</div>
        <RouterLink v-for="item in opsNav" :key="item.to" :to="item.to"
          :class="['app-nav-item', isActive(item.to) && 'active']">
          <i :class="`ph ${item.icon}`" class="nav-icon"></i>{{ item.label }}
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-user-info">
          ...
          <div class="sidebar-user-role">Location Manager</div>
        </div>
    ...
    <main class="app-main">
      <header class="app-topbar">
        <div class="topbar-title">Location Admin</div>
