    ...
    <aside class="app-sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        >
          ...
          {{ item.label }}
          <span v-if="item.badge" class="nav-ai-badge">AI</span>
        </RouterLink>
      </nav>

      <!-- User footer -->
      <div class="sidebar-footer">
        <div class="sidebar-user-avatar vip">MJ</div>
        <div class="sidebar-user-info">
          <div class="sidebar-user-name">Marcus Johnson</div>
          <div class="sidebar-user-role">VIP Member</div>
        </div>
...
.app-sidebar::before {
  ...
  height: 200px;
  background: radial-gradient(ellipse at 50% -30%, rgba(201,168,76,0.07) 0%, transparent 70%);
  pointer-events: none;
}
